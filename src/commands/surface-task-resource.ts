import { runSurfaceTask, type SurfaceTaskOptions } from './surface-task.js';
import { runListSurfaceTasks, type ListSurfaceTasksOptions } from './list-surface-tasks.js';
import { runUpdateSurfaceTask, type UpdateSurfaceTaskOptions } from './update-surface-task.js';

interface SurfaceTaskResourceOptions extends SurfaceTaskOptions, ListSurfaceTasksOptions, UpdateSurfaceTaskOptions {}

export function runSurfaceTaskResource(subcommand: string, args: string[], options: SurfaceTaskResourceOptions = {}): void {
